...
__device__ inline st_subtile<ST, subtile_rows, subtile_cols> subtile_inplace(ST &src, int2 rowcol) {
    ...
    static_assert(subtile_rows % ST::underlying_tile_rows == 0);
    static_assert(subtile_cols % ST::underlying_tile_cols == 0);
    static_assert(ST::height % (subtile_rows/ST::underlying_tile_rows) == 0);
    static_assert(ST::width % (subtile_cols/ST::underlying_tile_cols) == 0);
