...
print("TK O: ", out[0, 0, :num_print, 0], "Max:", out.max().item())
print("AITER O: ", out_ref[0, 0, :num_print, 0], "Max:", out_ref.max().item())
# print("TK LSE: ", lse[0, 0, 0, :num_print], "Max:", lse.max().item())
# print("AITER LSE: ", lse_ref[0, 0, :num_print], "Max:", lse_ref.max().item())
